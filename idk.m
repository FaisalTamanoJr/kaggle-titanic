...
train.Embarked = double(train.Embarked == 'S') * 0 + ...
                 double(train.Embarked == 'C') * 1 + ...
                 double(train.Embarked == 'Q') * 3;

test.Embarked = double(test.Embarked == 'S') * 0 + ...
                double(test.Embarked == 'C') * 1 + ...
                double(test.Embarked == 'Q') * 3;
...
RandomForest = TreeBagger(100, X_train, Y_train, 'Method', 'classification', ...
...
T = table(test.PassengerId, Y_predict, 'VariableNames', {'PassengerId', 'Survived'});
writetable(T, 'NEWsubmission2.csv');
